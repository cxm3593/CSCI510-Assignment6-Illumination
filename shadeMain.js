...
function setUpPhong(program) {
	...
	let ambientLight_vec3 = glMatrix.vec3.fromValues(0.5, 0.2, 0.3);
	gl.uniform3fv (program.ambientLight, ambientLight_vec3);
	let lightPos_vec3 = glMatrix.vec3.fromValues(1.0, -3.0, -3.0);
	...
	// Setting object color parameters
	...
	// Setting Phone parameters
	let ka = 0.1; // ambient coefficient
	let kd = 0.6; // diffuse coefficient
...
function setUpCamera(program) {
	...
	glMatrix.mat4.perspective(projMatrix, 0.4, 1.0, 1.0, 300.0);
	gl.uniformMatrix4fv (program.uProjT, false, projMatrix);

    // set up your view
	let viewMatrix = glMatrix.mat4.create();
    glMatrix.mat4.lookAt(viewMatrix, [0, 0, -10], [0, 0.0, 0], [0, 1, 0]);
